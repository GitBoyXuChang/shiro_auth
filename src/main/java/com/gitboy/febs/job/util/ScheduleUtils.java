package com.gitboy.febs.job.util;
...
public class ScheduleUtils {
     ...
     * 创建定时任务
     */
    public static void createScheduleJob(Scheduler scheduler, com.gitboy.febs.job.domain.Job scheduleJob) {
        try {
            // 构建job信息
     ...
     * 更新定时任务
     */
    public static void updateScheduleJob(Scheduler scheduler, com.gitboy.febs.job.domain.Job scheduleJob) {
        try {
     ...
     * 立即执行任务
     */
    public static void run(Scheduler scheduler, com.gitboy.febs.job.domain.Job scheduleJob) {
        try {
            // 参数
