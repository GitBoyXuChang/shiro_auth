...
import com.gitboy.febs.common.domain.LimitType;
import com.gitboy.febs.common.exception.LimitAccessException;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.gitboy.febs.common.annotation.Limit)")
